...
I saw the CDP's logo on the front of a recent Pacific Institute report (see [post](https://www.musclesofquartz.com/post/tuesday-water-reading/) from Tuesday), so I thought I'd check out their data. They've surveyed the water utilities of hundreds cities to characterize global urban water supply risks. 
...
Each risk is categorized by each city according to its seriousness. This is where the survey became silly. Clearly a utility's definition of "extremely serious" is completely context dependent; this problem will emerge in the final plot.
...
These data are clearly useless. A lot of work must have gone into contacting several hundred water utilities around the world. It's a great shame that the survey team failed to collect any quantifiable statistics that would allow for a reasonable comparison of the water supply risks faced by the world's cities.
